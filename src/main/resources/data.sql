...
INSERT INTO properties (id, property_type, built_area, bedrooms, bathrooms, floor, condition, description,
...
VALUES
(1, 'Piso', 85, 3, 2, 2, 'Reformado', 'Luminoso y amplio piso céntrico.', true, true, false, false, true, true, false,
 'España', 'Comunidad de Madrid', 'Madrid', 'Madrid', 'Centro', 'Justicia', 'user1', CURRENT_TIMESTAMP),
(2, 'Ático', 70, 2, 1, 5, 'Buen estado', 'Ático con vistas y terraza.', true, true, true, true, true, true, false,
 'España', 'Cataluña', 'Barcelona', 'Barcelona', 'Eixample', 'Dreta Eixample', 'user2', CURRENT_TIMESTAMP),
(3, 'Chalet', 200, 5, 3, 0, 'Nuevo', 'Chalet con jardín y piscina.', true, false, true, true, true, true, true,
 'España', 'Andalucía', 'Sevilla', 'Sevilla', 'Nervión', 'La Buhaira', 'user3', CURRENT_TIMESTAMP),
(4, 'Estudio', 40, 1, 1, 1, 'Necesita reforma', 'Estudio ideal para inversión.', false, false, false, false, false, false, false,
 'España', 'Comunidad Valenciana', 'Valencia', 'Valencia', 'Ciutat Vella', 'El Carmen', 'user4', CURRENT_TIMESTAMP),
(5, 'Dúplex', 120, 4, 2, 3, 'Buen estado', 'Dúplex amplio con parking.', true, true, true, false, false, true, false,
 'España', 'Galicia', 'A Coruña', 'Santiago', 'Casco Histórico', 'Vite', 'user5', CURRENT_TIMESTAMP),
(6, 'Apartamento', 60, 2, 1, 4, 'Reformado', 'Apartamento céntrico y moderno.', true, false, false, false, true, false, false,
 'España', 'País Vasco', 'Bizkaia', 'Bilbao', 'Abando', 'Indautxu', 'user6', CURRENT_TIMESTAMP),
(7, 'Piso', 90, 3, 2, 1, 'Nuevo', 'Piso en zona residencial.', true, true, true, false, false, true, true,
